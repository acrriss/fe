...
<template>
    ...
    <div class="flex min-h-screen items-center justify-center px-4">
        <div class="w-full max-w-sm">
            ...
            <p class="mb-6 text-center text-sm text-gray-500">Panel de contribuyentes</p>
            ...
            <p class="mt-4 text-center text-sm text-gray-500">
                ¿Sin cuenta?
                <Link href="/registro" class="font-medium text-indigo-600 hover:underline">Registre su empresa</Link>
            </p>
        </div>
    </div>
</template>

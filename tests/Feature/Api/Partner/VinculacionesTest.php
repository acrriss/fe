...
describe('solicitud de vinculación (§11, 7d)', function () {
    it('crea la solicitud pendiente para un RUC de cuenta directa', function () {
        $directo = Contribuyente::factory()->create(['ruc' => '0992223334001']);
        actuar_como_partner();
    ...
    it('es idempotente mientras la solicitud siga pendiente', function () {
        ...
        $primera = $this->postJson(route('api.partner.v1.vinculaciones.solicitar'), ['ruc' => '0992223334001']);
        $segunda = $this->postJson(route('api.partner.v1.vinculaciones.solicitar'), ['ruc' => '0992223334001']);
    ...
    it('responde 404 si el RUC no está registrado', function () {
        ...
        $this->postJson(route('api.partner.v1.vinculaciones.solicitar'), ['ruc' => '0992223334001'])
            ->assertNotFound();
    });
    ...
    it('responde 409 si ya gestiona ese contribuyente o lo gestiona otro partner', function () {
        ...
        $deOtro = contribuyente_gestionado(Partner::factory()->create(), ['ruc' => '0992223334001']);
